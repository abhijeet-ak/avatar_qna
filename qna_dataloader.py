...
class SquadDataset(Dataset):
    ...
    def __init__(
        ...
        self.processor = SquadProcessor(data_file=None, mode=INFERENCE_MODE)  # data_file=data, mode=mode)
        self.mode = mode
        self.examples = self.processor._create_examples(data, set_type=INFERENCE_MODE)
        # removed caching
